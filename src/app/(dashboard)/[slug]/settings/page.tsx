    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">Configure your system preferences and behavior</p>
        </div>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input id="siteName" {...register("siteName")} placeholder="My Inventory System" />
                ...
                <div className="space-y-2">
                  ...
                  />
                  {errors.siteDescription && <p className="text-sm text-red-500">{errors.siteDescription.message}</p>}
                </div>
                <div className="space-y-2">
                  <Label htmlFor="contactPhone">Contact Phone</Label>
                  <Input id="contactPhone" {...register("contactPhone")} placeholder="+1 (555) 123-4567" />
          ...
          <TabsContent value="business" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Configure business-related preferences</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="space-y-2">
                    ...
                    <Select onValueChange={(value) => setValue("currency", value)}>
                      <SelectTrigger>
                        <SelectValue placeholder={watchedValues.currency || "Select currency"} />
                      </SelectTrigger>
                      <SelectContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Configure shop behavior and checkout options</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">Make phone number mandatory during checkout</p>
                    </div>
                    <Switch
                      checked={watchedValues.requirePhoneNumber}
                      onCheckedChange={(checked) => setValue("requirePhoneNumber", checked)}
                    />
                  </div>
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select onValueChange={(value) => setValue("defaultOrderStatus", value as any)}>
                      <SelectTrigger>
                        <SelectValue placeholder={watchedValues.defaultOrderStatus || "Select status"} />
                      </SelectTrigger>
                      <SelectContent>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => setValue("orderNotifications", checked)}
                  />
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      placeholder="10"
                    />
                    {errors.itemsPerPage && <p className="text-sm text-red-500">{errors.itemsPerPage.message}</p>}
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="defaultView">Default View</Label>
                    <Select onValueChange={(value) => setValue("defaultView", value as "grid" | "list")}>
                      <SelectTrigger>
                        <SelectValue placeholder={watchedValues.defaultView || "Select view"} />
                      </SelectTrigger>
                      <SelectContent>
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-muted-foreground">Display products that are out of stock in the shop</p>
                  </div>
                  <Switch
                    checked={watchedValues.showOutOfStock}
                    onCheckedChange={(checked) => setValue("showOutOfStock", checked)}
                  />
                </div>
              </CardContent>
            </Card>
          ...
          <TabsContent value="security" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Configure security and authentication preferences</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      placeholder="24"
                    />
                    {errors.sessionTimeout && <p className="text-sm text-red-500">{errors.sessionTimeout.message}</p>}
                  </div>
                  <div className="space-y-2">
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-muted-foreground">Enforce strong password requirements for new users</p>
                  </div>
                  <Switch
